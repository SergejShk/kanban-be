...
export class AuthController extends Controller {
  ...
  private signUp: RequestHandler<{}, BaseResponse<IUser>> = async (
    req,
    res
  ) => {
  ...
  private getMe: RequestHandler<{}, BaseResponse<IUser>> = async (
    req,
    res,
    next
  ) => {
  ...
  private refreshAccessToken: RequestHandler<{}, BaseResponse<{}>> = async (
    req,
    res,
    next
  ) => {
  ...
  private logOut: RequestHandler<{}, BaseResponse<{}>> = async (
    req,
    res,
    next
  ) => {
